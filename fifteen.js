...
window.onload = function() {
  ...
  var movements = document.createElement("div");
   $("puzzlearea").appendChild(movements); //This div acts as the free move 
   blankP(movements);
...
var blankP = function(kk){
  kk.removeClassName("movablepiece");
  kk.addClassName("puzzlepiece");
  kk.style.float = "left";
  kk.style.backgroundImage = "none";
  kk.style.border = "2px solid white";
};
...
var regularP = function(p){
      ...
      p.style.backgroundImage = "url(AlleBerry.jpg)";
